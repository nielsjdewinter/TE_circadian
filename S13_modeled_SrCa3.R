...
root <- "E:/Dropbox/Research/Manuscripts/[Review] Biogeosciences - Circadian_TE/SI/S13 Smoothing by spot size" #set your root directory
setwd(root)
