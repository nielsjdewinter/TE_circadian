# Script to carry out a decomposition of variance lost from records by employing successive data processing steps
...
load("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Pectinids_Lukas/Datasets_dated/Increment_based/Shell2_2_dated_cross.rda") # Load Shell2_2 data
dat2_2 <- dat_trim # Rename to avoid conflict
dat2_2_trim <- dat2_2[which(dat2_2$Depth > 3500), ]

load("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Pectinids_Lukas/Datasets_dated/Increment_based/Shell3_1_dated_aligned_cross.rda") # Load Shell3_1 data
dat3_1 <- dat_trim # Rename to avoid conflict
dat3_1_trim <- dat3_1[which(dat3_1$Depth > 1000), ]

load("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Pectinids_Lukas/Datasets_dated/Increment_based/Shell3_2_dated_cross.rda") # Load Shell3_2 data
dat3_2 <- dat_trim # Rename to avoid conflict
dat3_2_trim <- dat3_2[which(dat3_2$Depth > 4500), ]

load("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Pectinids_Lukas/Datasets_dated/Increment_based/Shell4_dated_cross.rda") # Load Shell4 data
dat4 <- dat_trim # Rename to avoid conflict
dat4_trim <- dat4[which(dat4$Depth > 2000), ]

maxima29 <- read.csv("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Tridacnids_Dan/LAICPMS data/Line_Tridacnid_NdW_29_recalc.csv")
...
maxima84 <- read.csv("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Tridacnids_Dan/LAICPMS data/Line_Tridacnid_NdW_84_recalc.csv")
...
squamosa85 <- read.csv("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Tridacnids_Dan/LAICPMS data/Line_Tridacnid_NdW_85_recalc.csv")
squamosa85_trim <- squamosa85[which((squamosa85$depth < 39.7) & (squamosa85$depth > 0.6)), ]

squamosaFRS1 <- read.csv("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Tridacnids_Dan/LAICPMS data/Line_Tridacnid_NdW_FRS1_recalc.csv")
squamosaFRS1_trim <- squamosaFRS1[which((squamosaFRS1$depth < 32.8) & (squamosaFRS1$depth > 0.04)), ]

squamosaM1 <- read.csv("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Tridacnids_Dan/LAICPMS data/Line_Tridacnid_NdW_M1_recalc.csv")
...
squamosinaSQSA1 <- read.csv("E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Tridacnids_Dan/LAICPMS data/Line_Tridacnid_NdW_SQSA1_recalc.csv")
...
dat2_1_filtered <- as.data.frame(cbind(dat2_1_trim2$Depth,
    ...
    apply(dat2_1_trim2[, c(2, 3, 5, 6)], 2, sgolayfilt, p = 3,
        pch = 1, n = 21) # 21 pts = about 1-2h (should not affect tidal cycles)
...
write.csv(combined_variance, "E:/Dropbox/Research/postdoc/Side projects/Bivalve photosymbiosis and gigantism/Figures/Variance_decomposition.csv")
